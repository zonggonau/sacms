...
### 2.5 Multi-Tenant Data Architecture
...
**AI Endpoints:** `generate` · `smart-fill` · `generate-schema` · `generate-component` · `generate-single-type` · `translate` · `summarize`
