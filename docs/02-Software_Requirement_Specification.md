...
Plan limits are enforced server-side and are part of the authorization model:
...
| pro | 10 |
| enterprise | 20 |
| custom | override via approved override |
...
| custom | override via approved override | override via approved override | override via approved override | override via approved override | override via approved override | override via approved override |

Edge rate limiting is separate from monthly API caps:

- Free: 100 requests/minute.
- Pro: 500 requests/minute.
- Enterprise and Custom: deployment-specific or approved custom limits.
