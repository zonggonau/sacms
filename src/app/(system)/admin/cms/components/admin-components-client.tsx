...
import { 
  Plus, MoreVertical, Edit, Trash2, Box, Puzzle, Layout,
...
import { deleteAdminComponentAction } from "@/actions/admin-components"
...
interface AdminComponentsClientProps {
  initialComponents: Component[]
}

export function AdminComponentsClient({ initialComponents }: AdminComponentsClientProps) {
  ...
  const handleDelete = async () => {
    ...
    startTransition(async () => {
      try {
        const res = await deleteAdminComponentAction(componentToDelete.id)
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <Button 
                ...
                onClick={() => router.push(`/admin/cms/components/new`)}
              >
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredComponents.map((component) => (
                      <TableRow key={component.id} className="group hover:bg-muted/5 transition-colors cursor-pointer" onClick={() => router.push(`/admin/cms/components/${component.slug}/edit`)}>
                        ...
                        <TableCell className="text-right pr-6">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="w-48">
                              <DropdownMenuItem onClick={() => router.push(`/admin/cms/components/${component.slug}/edit`)}>
                              ...
                              {!component.isGlobal && (
                                <>
                                  ...
                                  <DropdownMenuItem 
                                    ...
                                    onClick={(e) => { e.stopPropagation(); handleDeleteClick(component)}}
                                  >
