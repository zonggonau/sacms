        ...
        <div className="p-4 md:p-6 lg:p-8 w-full max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Button variant="ghost" size="icon" className="rounded-xl h-8 w-8 hover:bg-muted/60" onClick={() => router.push(`/dashboard/${tenantSlug}/developer/component`)}>
            ...
            <div className="flex items-center gap-2">
              ...
              <Button className="h-8 px-4 text-xs font-bold rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground shadow-xs" asChild>
                <Link href={`/dashboard/${tenantSlug}/developer/component/${componentSlug}/edit`}>
