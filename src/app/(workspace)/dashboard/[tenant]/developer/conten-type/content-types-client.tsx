                    ...
                    <TableBody>
                      {filteredTypes.map((ct) => (
                        <TableRow
                          ...
                          onClick={() => router.push(`/dashboard/${tenantSlug}/developer/conten-type/edit/${ct.slug}`)}
                        >
                            ...
                            <div className="flex items-center justify-end gap-1.5">
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="w-48 rounded-xl">
                                  <DropdownMenuItem onClick={() => router.push(`/dashboard/${tenantSlug}/developer/conten-type/edit/${ct.slug}`)} className="text-xs cursor-pointer rounded-lg">
