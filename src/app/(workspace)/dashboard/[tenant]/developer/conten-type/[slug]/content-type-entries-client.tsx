          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Button 
                ...
                onClick={() => router.push(`/dashboard/${tenantSlug}/developer/conten-type/edit/${contentTypeSlug}`)}
              ...
              <Button 
                ...
                onClick={() => router.push(`/dashboard/${tenantSlug}/developer/conten-type/${contentTypeSlug}/new`)}
                        ...
                        <TableRow key={entry.id} className="group hover:bg-muted/40 transition-colors border-b border-border/60">
                          ...
                          <TableCell className="text-right pr-6 py-3">
                            <div className="flex justify-end gap-1">
                              ...
                              <Button variant="ghost" size="icon" className="h-7 w-7 rounded-lg text-muted-foreground hover:text-foreground" onClick={() => router.push(`/dashboard/${tenantSlug}/developer/conten-type/${contentTypeSlug}/${entry.id}/edit`)}>
