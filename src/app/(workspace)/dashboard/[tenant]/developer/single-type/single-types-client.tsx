          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <Button 
                ...
                onClick={() => router.push(`/dashboard/${tenantSlug}/developer/single-type/new`)}
                    ...
                    <TableBody>
                      {filteredSingleTypes.map((st) => (
                        <TableRow 
                          ...
                          onClick={() => router.push(`/dashboard/${tenantSlug}/developer/single-type/${st.slug}/edit`)}
                        >
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="w-48 rounded-xl">
                                  ...
                                  {(!st.isGlobal || isGlobalTenant) && (
                                    <DropdownMenuItem onClick={() => router.push(`/dashboard/${tenantSlug}/developer/single-type/${st.slug}/edit`)} className="text-xs cursor-pointer rounded-lg">
