  ...
  const handleSave = async (publishNow: boolean = false) => {
    ...
    try {
      ...
      if (publishNow) {
        ...
        router.push(`/dashboard/${tenantSlug}/developer/single-type`)
      } else {
        ...
        <div className="p-4 md:p-6 lg:p-8 w-full max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Button variant="ghost" size="icon" className="rounded-xl h-8 w-8 hover:bg-muted/60" onClick={() => router.push(`/dashboard/${tenantSlug}/developer/single-type`)}>
            ...
            <div className="flex items-center gap-2">
              ...
              <Button variant="outline" className="h-8 px-3 text-xs font-bold rounded-xl border-border/80" asChild>
                <Link href={`/dashboard/${tenantSlug}/developer/single-type/${singleType.slug}/edit`}>
