            ...
            <div className="flex items-center gap-3">
              ...
              >
                {isLimitReached ? (
                  ...
                  <Link href={`/developer/${tenantSlug}/content-type-builder/components/new`}>
                    <Plus className="mr-1.5 h-4 w-4" /> Buat Komponen
                  </Link>
                )}
              </Button>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div className="min-w-0">
                                <div className="flex items-center gap-2">
                                  <Link 
                                    href={`/developer/${tenantSlug}/content-type-builder/components/${component.slug}`}
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end" className="w-48 rounded-xl">
                                <DropdownMenuItem asChild className="text-xs cursor-pointer rounded-lg">
                                  <Link href={`/developer/${tenantSlug}/content-type-builder/components/${component.slug}`}>
