          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2.5">
              <Button
                ...
                onClick={() => router.push(`/cms/${tenantSlug}`)}
              ...
              <Button
                ...
                onClick={() => router.push(`/developer/${tenantSlug}/content-type-builder/content-types/new`)}
                    ...
                    <TableBody>
                      {filteredTypes.map((ct) => (
                        <TableRow
                          ...
                          onClick={() => router.push(`/developer/${tenantSlug}/content-type-builder/content-types/edit/${ct.slug}`)}
                        >
                          ...
                          <TableCell className="text-right pr-6 py-3" onClick={(e) => e.stopPropagation()}>
                            <div className="flex items-center justify-end gap-1.5">
                              <Button
                                ...
                                onClick={() => router.push(`/cms/${tenantSlug}/content/${ct.slug}`)}
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="w-48 rounded-xl">
                                  <DropdownMenuItem onClick={() => router.push(`/developer/${tenantSlug}/content-type-builder/content-types/edit/${ct.slug}`)} className="text-xs cursor-pointer rounded-lg">
                                    <Edit className="mr-2 h-3.5 w-3.5" /> Edit Skema
                                  </DropdownMenuItem>
                                  <DropdownMenuItem onClick={() => router.push(`/cms/${tenantSlug}/content/${ct.slug}`)} className="text-xs cursor-pointer rounded-lg">
