  ...
  const handleSave = async (publishNow: boolean = false) => {
    ...
    try {
      ...
      if (publishNow) {
        ...
        router.push(`/developer/${tenantSlug}/content-type-builder/single-types`)
      } else {
        ...
        <div className="p-4 md:p-6 lg:p-8 w-full max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Button variant="ghost" size="icon" className="rounded-xl h-8 w-8 hover:bg-muted/60" onClick={() => router.push(`/developer/${tenantSlug}/content-type-builder/single-types`)}>
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" className="h-8 px-3 text-xs font-bold rounded-xl border-border/80 text-foreground hover:bg-muted shadow-xs flex items-center gap-1.5" asChild>
                <Link href={`/cms/${tenantSlug}/single-types/${singleType.slug}`} title="Buka entri single type di CMS Studio">
              ...
              <Button variant="outline" className="h-8 px-3 text-xs font-bold rounded-xl border-border/80" asChild>
                <Link href={`/developer/${tenantSlug}/content-type-builder/single-types/${singleType.slug}/edit`}>
