          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2.5">
              <Button
                ...
                onClick={() => router.push(`/cms/${tenantSlug}/single-types`)}
              ...
              <Button 
                ...
                onClick={() => router.push(`/developer/${tenantSlug}/content-type-builder/single-types/new`)}
                    ...
                    <TableBody>
                      {filteredSingleTypes.map((st) => (
                        <TableRow 
                          ...
                          onClick={() => router.push(`/developer/${tenantSlug}/content-type-builder/single-types/${st.slug}/edit`)}
                        >
                            ...
                            <div className="flex justify-end gap-1.5 items-center">
                              ...
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end" className="w-48 rounded-xl">
                                  <DropdownMenuItem onClick={() => router.push(`/cms/${tenantSlug}/single-types/${st.slug}`)} className="text-xs cursor-pointer rounded-lg">
                                    <Layout className="mr-2 h-3.5 w-3.5" /> Buka Entri CMS
                                  </DropdownMenuItem>
                                  {(!st.isGlobal || isGlobalTenant) && (
                                    <DropdownMenuItem onClick={() => router.push(`/developer/${tenantSlug}/content-type-builder/single-types/${st.slug}/edit`)} className="text-xs cursor-pointer rounded-lg">
