  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.autoVerified) {
        ...
        const loginUrl = `/login?email=${encodeURIComponent(formData.email)}${redirectTo ? '&redirect_to=' + encodeURIComponent(redirectTo) : '&redirect_to=' + encodeURIComponent('/dashboard')}`
