...
export async function createComponentAction(tenantSlug: string, data: any) {
  try {
    ...
    revalidatePath(`/developer/${tenantSlug}/content-type-builder/components`)
    return { component }
  } catch (error) {
...
export async function updateComponentAction(tenantSlug: string, id: string, data: any) {
  try {
    ...
    revalidatePath(`/developer/${tenantSlug}/content-type-builder/components`)
    revalidatePath(`/developer/${tenantSlug}/content-type-builder/components/${updatedComponent.slug}/edit`)
