...
export const updateTenantSettingsSchema = z.object({
  ...
  apiVersion: z.string().max(20).optional().nullable(),
  ...
  corsOrigins: z.string().max(2000).optional().nullable(),
  previewUrl: z.string().max(1000).optional().nullable(),
  twoFactorRequired: z.boolean().optional(),
  ipWhitelist: z.boolean().optional(),
  allowedIps: z.string().max(2000).optional().nullable(),
  auditLogging: z.boolean().optional(),
  databaseUrl: z.string().max(2000).optional().nullable(),
  storageConfig: z.any().optional().nullable(),
